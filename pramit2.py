#!/usr/bin/python
#Original written By Pramit Acharya
...
def PRAMIT():   
    ...
    print(f'[W] AAFNO KAAM GAR MUJI WHATSAPP JOIN GAR')
    print(f'[F]Facebook  ')
    print('')
    ...
    if select =='1':
       ...
       cutter()
        ...
        os.system('xdg-open https://chat.whatsapp.com/GfYQ44y7Nm255EOccOnxek')
        pass
    elif select =='F':
        os.system('xdg-open https://www.facebook.com/pramit.acharya.1?mibextid=2JQ9oc/')
    else:
        print('\n Select valid option ... ')
        time.sleep(2)
        PRAMIT(allkey)
